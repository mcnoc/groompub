...
class Shop extends Admin_Controller {
    ...
    public function update_new_shop_name() {
      $id = $this->input->post('id');
      $shop_new_name = $this->input->post('shop_new_name');
      // echo $id.','.$shop_new_name;exit;
      if(!empty($id)) {
        $data = array(
          'shop_name' => $shop_new_name,
          'changed_shop_name' => '',
          'is_shop_name_approved' => '0'
        );
        // print_r($data);exit;
        $updated_id = $this->general_model->update_shop_data($data, 'shop', array('id' => $id));
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    redirect('shop/add_shop', 'refresh');
                     ...
                     // if(isset($city)){
					  ...
					  $shop_count = $this->general_model->check_exist_data('id', 'shop', array('shop_name' => $name, 'city' => $city));
