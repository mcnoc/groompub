    ...
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            ...
            <a href="<?php echo site_url(); ?>" class="site_title sidebar_logo">
              <img src="<?php //echo site_url($adminlogoimg);?>" alt=""> <span>Groom</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              ...
              <?php if($admin_data[0]['user_promotion'] != 3){?>
                <li><a><i class="fa fa-users"></i> Users <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <?php if($admin_data[0]['user_promotion'] != 3){?>
                    <li><a href="<?php echo site_url('user') ?>"> App Users </a></li>
                    <?php }?>
                    <?php if($admin_data[0]['user_promotion'] == 1){?>
                    <li><a href="<?php echo site_url('admin') ?>"> Groom Users </a></li>
                    <?php }?>
                  </ul>
                </li>
              <?php }?>
              ...
              <li>
                <a href="<?php echo site_url('shop') ?>"><i class="fa fa-cart-arrow-down"></i> Shops </a>
              </li>
              <?php if($admin_data[0]['user_promotion'] != 3){?>
                 <li><a href="<?php echo site_url('worker') ?>"><i class="fa fa-users"></i> Workers </a></li> 
                <li><a href="<?php echo site_url('service') ?>"><i class="fa fa-cogs"></i> Services </a></li>
                <li><a><i class="fa fa-calendar-check-o"></i>Appointments <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                ...
                <li><a><i class="fa fa-location-arrow"></i>Locations <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
