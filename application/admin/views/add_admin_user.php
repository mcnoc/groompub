                      ...
                      <div class="col-md-8 col-xs-12">
                       <div class="item form-group">
                         <label class="control-label1 col-xs-12" for="product">First name</label><br>
                          <div class="col-xs-12">
                            <input id="fname" class="form-control col-md-7 col-xs-12" name="fname" type="text" required>
                          </div>
                        </div>
                        <div class="item form-group">
                          <label class="control-label1 col-xs-12" for="product">Last name</label><br>
                           <div class="col-xs-12">
                             <input id="lname" class="form-control col-md-7 col-xs-12" name="lname" type="text" required>
                           </div>
                         </div>
                         <div class="item form-group">
                           <label class="control-label1 col-xs-12" for="product">Email</label><br>
                            <div class="col-xs-12">
                              <input id="u_email" class="form-control col-md-7 col-xs-12" name="u_email" type="text" required>
                            </div>
                          </div>
                           ...
                           <label class="control-label1 col-xs-12" for="product">password</label><br>
                            <div class="col-xs-12">
                              <input id="password" class="form-control col-md-7 col-xs-12" name="password" type="text" required>
                            </div>
                          </div>
...
<script type="text/javascript">
 ...
 $('input[name="u_2_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_2").prop("checked", true);
            
            }
      });
	  $('input[name="u_2_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_2").prop("checked", true);
              
            }
      });
	  $('input[name="u_2_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_2").prop("checked", true);
      ...
      $('input[name="u_3_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_3").prop("checked", true);
            
            }
      });
	  $('input[name="u_3_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_3").prop("checked", true);
              
            }
      });
	  $('input[name="u_3_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_3").prop("checked", true);
      ...
      $('input[name="u_4_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_4").prop("checked", true);
            
            }
      });
	  $('input[name="u_4_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_4").prop("checked", true);
              
            }
      });
	  $('input[name="u_4_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_4").prop("checked", true);
      ...
      $('input[name="u_5_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_5").prop("checked", true);
            
            }
      });
	  $('input[name="u_5_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_5").prop("checked", true);
              
            }
      });
	  $('input[name="u_5_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_5").prop("checked", true);
      ...
      $('input[name="u_6_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_6").prop("checked", true);
            
            }
      });
	  $('input[name="u_6_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_6").prop("checked", true);
              
            }
      });
	  $('input[name="u_6_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_6").prop("checked", true);
      ...
      $('input[name="u_7_1"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_7").prop("checked", true);
            
            }
      });
	  $('input[name="u_7_2"]').click(function(){
            if($(this).prop("checked") == true){
              $("#u_7").prop("checked", true);
              
            }
      });
	  $('input[name="u_7_3"]').click(function(){
            if($(this).prop("checked") == true){
             $("#u_7").prop("checked", true);
