...
<div class="right_col" role="main" style="min-height: 500px;"><br>
  <h1>Dashboard</h1>
  <br>
    <!-- top tiles -->
      ...
      <?php if($admin_data[0]['user_promotion'] != 3){?>
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <a href="<?php echo site_url('User');?>">
                <div class="tile-stats" style="background-color: #5f5d52;">
                    <div class="icon color-white"><i class="fa fa-users"></i></div>
        ...
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <a href="<?php echo site_url('Category');?>">
                <div class="tile-stats" style="background-color: #bc978f99;">
        ...
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <a href="<?php echo site_url('Shop');?>">
                <div class="tile-stats" style="background-color: #FF7F50;">
                    <div class="icon color-white"><i class="fa fa-cart-arrow-down"></i></div>
          ...
          <div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <a href="<?php echo site_url('Appointment');?>">
                  <div class="tile-stats" style="background-color: #3CB371;">
                      <div class="icon color-white"><i class="fa fa-calendar-check-o"></i></div>
          ...
          <div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <a href="<?php echo site_url('service');?>">
                  <div class="tile-stats" style="background-color: #8FBC8F;">
                      <div class="icon color-white"><i class="fa fa-cogs"></i></div>
    ...
    <div class="row">
        <div class="col-md-12" style="font-size: 22px; color: #696969;"><b>Transaction Summary </b></div>
    ...
    <!-- <div class="row">
      <div class="col-md-12" style="font-size: 22px; color: #696969;margin-bottom: 20px;"><b>Service Matrix</b></div>
      <div class="col-md-12">
      <div class="col-md-2">
   ...
   <!--  <div class="col-md-12 col-xs-12">
    ...
    <!-- <div class="row">
      <div class="col-md-12" style="font-size: 22px; color: #696969;"><b>Web Matrix</b> </div>
    ...
    <!-- <div class="row">
      <div class="col-md-12" style="font-size: 22px; color: #696969;"><b>Location and Payment Matrix </b></div>
