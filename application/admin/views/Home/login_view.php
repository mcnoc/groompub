        ...
        <div class="row1" style="height:600px">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="" style="margin-top: 10%;">
                ...
                <div class="x_panel" style="margin-top: 2% !important;background-color: #1abb9c;">
                    <div class="x_title">
                        <h1><center>Groom Admin Panel</center> </h1>
                    ...
                    <div class="x_content">
                        <form enctype="multipart/form-data" method="post" class="form-horizontal" id="frm_login" name="frm_login" data-toggle="validator" action="<?php echo site_url("Login/login"); ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="password" class="form-control col-md-7 col-xs-12" name="password" placeholder="Password"  required="" type="password">
                                </div>
                            </div>
                            <div class="item form-group">
                            <div class="col-md-9 col-xs-12">
                                <a class="pull-right" href="<?php echo site_url('Dashboard/Forgotpassword');?>" style="color:#085290;">Forgot password</a>
                            </div>
                            </div>
