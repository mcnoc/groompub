        ...
        if($this->facebook->is_authenticated()){
            ...
            if(!empty($userID)){
                ...
                //print_r($userData);
                 ...
                 $sess_data = array('login' => TRUE, 'email' => $userData['email'], 'username' => $userData['firstname'], 'uid' => $userData['uid'], 'firstname' => $userData['firstname'], 'usertype' => $uresult[0]->u_category);
