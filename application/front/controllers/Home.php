    ...
    public function index2() {
      ...
      $this->data['footer_pages3'] = $footer_pages3;
        ...
        $this->data['filter_service_list'] = $filter_service_list;
          ...
          $filter_service_list_price = $this->general_model->get_filter_service_data_price( 'services', array('is_deleted' => 0));
        $this->data['filter_service_list_price'] = $filter_service_list_price;
...
public function fetch()
 {
  ...
  if($data->num_rows() > 0)
  {
   ...
   {
    $output .= '
     <option style="margin-left:10%;" value="'.$row->service_name.'" onclick="MakeBold(this.value);">'.$row->service_name.'</option>
    ';
   }
  }
  else
  {
   $output .= '<option style="margin-left:10%;"></option>';
  }
  $output .= '</table>';
  echo $output;
 }
