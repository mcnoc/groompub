      ...
      if($this->input->post())
      {
        ...
        $payment_type = $this->input->post('payment_type');
         ...
         $user_list = $this->general_model->get_user_data('*', 'user', array('id' => $userId, 'is_deleted' => 0));
           ...
           $new_wallet = $user_list->wallet - $totalprice;
           $my_wallet = array(
            'wallet' =>$new_wallet
           );

           $this->general_model->update_general_data($my_wallet, 'user', array('id' => $userId,'is_deleted' => 0));
          ...
          $this->general_model->create_general_data($data1,'wallet_history');
