...
<section id="Custbooking" style="padding-top: 57px !important;">
<div class="container">
<div class="card shadow ml-auto mr-auto mt-5 mb-5">
   
    <div class="card-body">
            <h4 class="card-title"><strong>Bookings</strong></h4>
            <p><b>What's coming up</b></p>
            <p class="card-text">You don't have anything coming up start looking for your next service.</p>
            <button class="btn exp_groom">Explore Groom</button>
    </div>

         
          <div class="container" style="margin-top: 30%;margin-bottom: 20%;">
              
              <h6><b>What you have booked</b></h6>
         
            <div class="card-deck mb-5 mt-5" id="top_rated">
              <div class="card shadow">
              <div class="card-img-caption">
              <img src="images/correct1.png" class="float-right check_img">
              <img src="images/braids.jpg" class="card-img" alt="...">
              </div>
              <div class="card-body">
                <div class="row">
                 <h6 class="card-title col-md-8 mt-1"><b>Crochet Braids</b></h6>
                 <button type="button" class="btn btn-success2 col-md-4">Book Again</button>
                </div>
