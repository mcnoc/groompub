...
<li id="wallet_price"><input type="radio" name="payment_option" id="radio7" class="css-checkbox paymentRadio" value="4"> <label for="radio7" class="css-label css-label-check radGroup1 radGroup2" style="margin-bottom: 21px;">WALLET</label></li>
</ul>
</div>
...
<input type="hidden" name="walletVlue" value="<?php echo $userlist->wallet; ?>" id="walletVlue">
...
<div class="col-md-4 col-md-offset-4 cls_ap_md4">
<div class="step-wrapper" :class="stepWrapperClass">
<!--  <button type="button" class="btn btn-primary" style="display:none;" @click="lastStep" :disabled="firststep"> Back </button>  -->
            
           <button type="button" class="btn btn-default full-width-btn emboss-btn btn_continue"  @click="lastStep"  v-if="!firststep" >
            Back
            </button>
<button type="button" class="btn btn-default full-width-btn emboss-btn btn_continue m-0" @click="nextStep" :disabled="laststep" v-if="!laststep">
Continue
</button>
...
var totalPrice1 = parseFloat($("#priceData").val());
var walletVlue1 = parseFloat($("#walletVlue").val());
console.log(totalPrice1);
console.log(walletVlue1);
console.log('shuaeb');

if(walletVlue1 >= totalPrice1 )
{
    $('#wallet_price').hide();
}
else
...
var totalPrice11 = parseFloat($("#priceData").val());
var walletVlue11 = parseFloat($("#walletVlue").val());


if(walletVlue11 >= totalPrice11 )
{
    $('#wallet_price').show();
}
else
...
swal({
  title: "Do you agree?",
  text: "Meeting or communicating with your Pro outside of GGGroom is not permitted.",
  type: "warning",
...
else if($(".paymentRadio:checked").val() == '4')
{
$("#overlay").show();
window.setTimeout(function(){
var orderid = $("#orderid").val();
...
console.log('form_data_squreup',form_data);
$.ajax({
url: site_url+"appointment/paymentWallet",
type: 'post',
data: form_data,
success: function (data) {
console.log('data_squ',data);
