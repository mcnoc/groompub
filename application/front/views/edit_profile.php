  ...
  document.getElementById("selecttext").style.display = 'none';
                    ...
                    <form action="<?php echo site_url("profile/update_user"); ?>" enctype="multipart/form-data" method="post" id="edit_user" name="edit_user" data-toggle="validator">
                        <div class="image_change" >
                            ...
                            <img src="<?=$main_image?>"  onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="chooseFile();" alt="" id="preview_image" title="" class="img-responsive img-circle upload_img" style="object-fit:cover; max-height:250px;max-width:250px"/>
                            <a id="OpenImgUpload" onmouseover="mouseOver()" onmouseout="mouseOut()"> <img src="<?=base_url()?>front/images/<?php echo $userlist->firstname;?>" alt="" title="" class="img-responsive img-circle camera_upload" /> </a>
                        </div>
                        <div style="display:none" id="selecttext" onmouseover="mouseOver()" onmouseout="mouseOut()">
                        <a class="imagechangetxt" onclick="chooseFile();"  style="color:blue;">Change Image</a></div>
                        <hr class="hr_line">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label for="fname">First Name <span class="cls_star">*</span></label>
                                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $userlist->firstname;?>" onkeypress="return (event.charCode > 64 && 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="zipcode" name="zipcode" value="<?php echo $userlist->zipcode;?>">
                                    </div>
                                </div>
                            </div>
                        </div>
