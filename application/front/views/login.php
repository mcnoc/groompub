          ...
          <div class="panel-body">
            <form action="<?php echo site_url("login/user_login");?>" enctype="multipart/form-data" method="post" class="form-horizontal" id="login_user" name="login_user" data-toggle="validator">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Username" name="uname" id="uname1" value="<?php if(isset($_COOKIE['rem_email'])){ echo $_COOKIE['rem_email'];}?>">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-12">
              ...
              <div class="form-submit">
          	  ...
          	  <div class="pass-forgot" style="">
	          	   ...
	          	   print_r($data);
	          	   ?>
	          	   <a href="<?php echo base_url("login/google_login");?>" style="color: white">Google Login &nbsp; |&nbsp;</a>  <a href="<?php echo $authURL; ?>" style="color: white">Facebook Login</a>
          	  </div>
