...
$this->load->view('templates/_include/search_filter_view1');
?>
<!-- <style media="screen">
span{
  color: #000;
...
<section class="related_services">
  <div class="container">
    <div class="">
     <div class="htext">
       <h2 style="color: #000;">Services</h2><br>
     </div>
    </div>
    </div>
    <div class="container">
     <div class="card-deck" id="top_rated">
      ...
      <!-- <div class="item"> -->
       <!-- <div class="col-md-6"> -->
         ...
         <img src="<?=$main_image?>" class="card-img" style="height: 345px;width: 360px;object-fit:cover;"></a>
       </div>
       <div class="card-body">
        ...
        <button type="button" class="btn btn-success2 col-md-4">  <a href="<?=base_url()?>detail/shop_detail/<?=$rated_service->shop_id?>/<?=$rated_service->encrypt_id?>">  Book</button></a>
          ...
          <!-- <p><?=$parent_cat?> $<?=$rated_service->price?></p> -->
          
 <p class="card-text"><small class="text-muted"><?=$rated_service->shop_name?></small><!-- <small class="text-muted float-right mt-1">45-60 min</small> --></p>
