...
<?php //print_r($workerlist);  die();?>
                  <div class="col-md-12" style="margin-bottom: 22px;">
              <input type="checkbox" name="worker_permission" id="worker_permission" value="1" class="css-checkbox" <?php echo ($workerlist->shop_permission=='1')?"checked":"" ;?> >
              <label for="worker_permission" class="css-label css-label-check" style="font-size: 23px;"> Shop Manager Permission</label>
            </div>
